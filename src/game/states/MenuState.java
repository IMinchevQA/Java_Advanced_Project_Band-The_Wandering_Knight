...
public class MenuState extends State {
    ...
    public MenuState(Handler handler){
        ...
        uiManager.addObject(new UIImageButton(300, 160, 412, 107, Assets.getMenuElement("btn_load"), new ClickListener() {
            @Override
            public void onClick() {
                handler.getMouseManager().setUIManager(null);
                handler.getMouseManager().setAboutManager(null);
        ...
        uiManager.addObject(new UIImageButton(420, 275, 231, 91, Assets.getMenuElement("btn_about"), new ClickListener() {
            @Override
            public void onClick() {
                handler.getMouseManager().setUIManager(null);
        ...
        uiManager.addObject(new UIImageButton(460, 375, 159, 107, Assets.getMenuElement("btn_quit"), new ClickListener() {
            @Override
            public void onClick() {
                System.exit(0);
            }
