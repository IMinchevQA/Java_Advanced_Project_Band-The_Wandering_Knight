...
//new
    ...
    private static Tile dirtTile = new WaterTile(WATER_ID);//A
    private static Tile grassTile = new GrassTile(GRASS_ID);
    private static Tile rockTile = new StoneTile(STONE_ID);//A
    //new
    private static Tile w_lilly = new W_lilly(W_LILLY_ID);
    private static Tile w_stone = new W_stone(W_STONE_ID);
    private static Tile mushroom1 = new Mushroom1(MUSHROOM1_ID);
    private static Tile mushroom2 = new Mushroom2(MUSHROOM2_ID);
    private static Tile bush1 = new Bush1(BUSH1_ID);
    private static Tile bush2 = new Bush2(BUSH2_ID);
    private static Tile bush3 = new Bush3(BUSH3_ID);
    private static Tile flower1 = new Flower1(FLOWER1_ID);
    private static Tile well_full = new Well_full(WELL_FULL_ID);
    private static Tile flower2 = new Flower2(FLOWER2_ID);

    private static Tile stone_wall_up1 = new Stone_wall_up1(STONE_WALL_UP1_ID);
    private static Tile stone_wall_up2 = new Stone_wall_up2(STONE_WALL_UP2_ID);
    private static Tile stone_wall_down1 = new Stone_wall_down1(STONE_WALL_DOWN1_ID);
    private static Tile stone_wall_down2 = new Stone_wall_down2(STONE_WALL_DOWN2_ID);
    private static Tile stone_wall_left = new Stone_wall_left(STONE_WALL_LEFT_ID);
    private static Tile stone_wall_right = new Stone_wall_right(STONE_WALL_RIGHT_ID);

    //iceland
    private static Tile snowTile = new SnowTile(SNOW_ID);
    private static Tile snowyBushTile = new SnowyBush(SNOW_BUSH_ID);
    //desert
    private static Tile sandTile = new Sand(SAND_ID);
    private static Tile cactus1Tile = new Cactus1(CACTUS1_ID);
    private static Tile cactus2Tile = new Cactus2(CACTUS2_ID);
